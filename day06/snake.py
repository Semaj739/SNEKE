...
from day04.snake import body_coords
...
while running:
    ...
    head_x = snake_dx
    head_y = snake_dy
    (head_x, head_y, SNAKE_SIZE, SNAKE_SIZE) = head_coord
    # Check for game over
    ...
    #resets the game
    score = 0
    head_x, head_y, head_coord, body_coords
